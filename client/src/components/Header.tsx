    ...
    <header className="flex items-center w-full p-4 md:py-2 md:px-6">
      ...
      <div className="flex items-center ml-auto cursor-pointer gap-2 relative">
        ...
        <div className="flex flex-col">
            ...
            <p className="flex items-center gap-2 text-xs text-grey-500 font-normal">Premium Member. <IconContext.Provider value={{color: "gold"}}><FaCrown /> </IconContext.Provider>  </p>
        </div>
      </div> 
    </header>
  );
